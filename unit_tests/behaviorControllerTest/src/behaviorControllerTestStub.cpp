...
int main(int argc, char** argv)
{
    ...
    ros::ServiceServer speechEventSetLanguageServer = nh.advertiseService("/speechEvent/set_language", speechEventSetLanguageHandler);
    ...
    gs.start();
    printMsg(INFO_MSG, "gestureExecution Action server Ready");
    ...
    tts.start();
    printMsg(INFO_MSG, "textToSpeech Action server Ready");
    ...
    ngs.start();
    printMsg(INFO_MSG, "robotNavigation/set_goal Action server Ready");
