 ...
 *
 * The component starts the 'Robot Mission Interpreter' ROS Node. This node is the starting point for the robot to
 * execute the mission selected.
 * Though, this component exists as a standalone and can be started as such, without the set of ROS nodes that are part
 * of the CSSR4Afica system architecture(see D3.1 System Architecture), it will not be able function.
...
 * Libraries
 * Standard libraries
...
int main(int argc, char** argv)
{
    ...
    std::string softwareVersion = "v1.1";
    std::string leftIndent = "\n\t\t";
    ROS_INFO_STREAM(nodeName << ": startup");
    ROS_INFO_STREAM("\n" + leftIndent + nodeName + ":\t" + softwareVersion + leftIndent + "This project is funded by the African Engineering and Technology Network (Afretec)" + leftIndent + "Inclusive Digital Transformation Research Grant Program.\n" + leftIndent + "Website: www.cssr4africa.org\n" + leftIndent + "This program comes with ABSOLUTELY NO WARRANTY.\n");
