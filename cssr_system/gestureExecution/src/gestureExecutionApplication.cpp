 ...
 *
 * /sensor_msgs/joint_states    sensor_msgs/JointState
 ...
 * Services Invoked
 *
 * /overtAttention/set_mode cssr_system/setMode
...
 * Services Advertised and Message Types
 *
 * /gestureExecution/perform_gesture    cssr_system/performGesture
...
 * Action Servers
 *
 ...
 * ----- rosservice call /perform_gesture -- deictic 01 LEFT PALM_UPWARDS 3000 25 3.6 2.5 0.82
...
int main(int argc, char** argv)
{
    ...
    actionlib::SimpleActionServer<cssr_system::performGestureAction> as(n, "/gestureExecution/perform_gesture", boost::bind(&execute_gesture_action, _1, &as), false);
