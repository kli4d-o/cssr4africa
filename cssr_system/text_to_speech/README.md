...
4. **Download TTS Model Files:**
   ...
   **Kinyarwanda YourTTS model:**
   ...
   unzip -j cssr4africa_models/text_to_speech/model.zip -d ~/workspace/pepper_rob_ws/src/cssr4africa/cssr_system/text_to_speech/models/rw_model
   ```
...
6. **Update Kinyarwanda model config.json paths:**
   ...
   - Line 226: Change to `/home/<user>/workspace/pepper_rob_ws/src/cssr4africa/cssr_system/text_to_speech/models/rw_model/speakers.pth`, where `<user>` is your username
